...
router.post('/', auth_middleware_1.authMiddleware, cloudinary_1.uploadPostImages.array('images', 5), nsfw_middleware_1.checkNsfw, post_controller_1.postController.create);
// Cập nhật bài viết
...
router.post('/:id/images', auth_middleware_1.authMiddleware, cloudinary_1.uploadPostImages.array('images', 5), nsfw_middleware_1.checkNsfw, post_controller_1.postController.addImages);
